...
_Given the transmission type does not have a significant impact on MPG.

1.Quantify the MPG difference between automatic and manual transmissions?

_Unable to quantify this regressors impact because it's insignificant by the calculated model
